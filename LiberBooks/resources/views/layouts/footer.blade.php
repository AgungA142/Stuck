<footer class="bg-[#8B7E74]" aria-labelledby="footer-heading">
  ...
  <div class="max-w-md mx-auto px-4 sm:max-w-7xl sm:px-6 lg:pt-16 lg:px-8">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="space-y-8 xl:col-span-1">
        <img class="h-52" src="http://localhost:8000/assets/img/logo.png" alt="Logo">
        <div class="flex space-x-6">
          <a href="#" class="text-black-400 hover:text-gray-700">
      ...
      <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          ...
          <div class="mt-12 md:mt-0">
            <h3 class="text-sm font-semibold text-black-400 tracking-wider uppercase">Legal</h3>
            <ul role="list" class="mt-4 space-y-4">
              <li>
                <a href="#" class="text-base text-[#434242] hover:text-gray-900"> Claim </a>
              </li>

              <li>
                <a href="/privacy" class="text-base text-[#434242] hover:text-gray-900"> Privacy </a>
              </li>

              <li>
                <a href="#" class="text-base text-[#434242] hover:text-gray-900"> Terms </a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="mt-8 border-t border-gray-200 py-4">
      <p class="text-base text-[#434242] hover:text-white xl:text-center">&copy; 2022 O-Library Development by Stuck Team, Inc. All rights reserved.</p>
    </div>
  </div>
</footer>