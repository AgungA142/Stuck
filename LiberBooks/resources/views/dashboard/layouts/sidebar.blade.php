...
x-transition:leave-end="-translate-x-full"
  ...
  <div class="relative flex w-full max-w-xs flex-1 flex-col bg-[#8B7E74]  pt-5 pb-4">
    ...
    <div class="flex flex-shrink-0 items-center px-4">
      <img class="h-32 w-auto" src="{{ asset('assets/logo.png') }}" alt="Your Company">
    </div>
...
<div class="flex min-h-0 flex-1 flex-col">
  <div class="flex justify-center pt-4 h-auto flex-shrink-0 items-center bg-[#8B7E74] px-4">
    <img class="h-32" src="{{ asset('assets/logo.png') }}" alt="Your Company">
  </div>
